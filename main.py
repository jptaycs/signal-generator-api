...
# they currently share identical interval/outputsize/dp params, but each call site still
# passes its own values explicitly so either can diverge later without touching this function.
